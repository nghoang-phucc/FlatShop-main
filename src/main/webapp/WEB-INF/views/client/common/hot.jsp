							...
							<div class="products">
								...
								<div class="thumbnail">
									<a href="product-details?productId=${product.productId}"><img
										style="width: 90%;" src="<c:url value="/resource/client/images/products/image/108_DW00100019-399x399.jpg" />"
										alt="Product Name"></a>
								</div>
					...
					<c:forEach items="${hotTwo}" var="product">
						<div class="col-md-3 col-sm-6">
							<div class="products">
								...
								<div class="thumbnail">
									<a href="product-details?productId=${product.productId}"><img
										style="width: 90%;" src="<c:url value="/resource/client/images/products/image/109_MTD-1060D-1A3VDF-1-399x399.jpg" />"
										alt="Product Name"></a>
								</div>
								<div class="productname">${product.productName}</div>
